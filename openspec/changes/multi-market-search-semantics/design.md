...
Z4 measures that same loopback adapter and prompt against human labels. Automated suites stay fake/offline. Z4 records the passing `model` and `prompt_version`; Z5 MUST refuse a different `BERA_TRACKER_OLLAMA_MODEL` or prompt.
